...
# the source kariz_code is modified version of redblack tree from http://code.activestate.com/recipes/576817-red-black-tree/
# Author: activestate.com, Mania Abdi

...
e,2,3
#t,103,24
v,0,GROUP_BY:COMBINER,ea2_lineitem,45,0.65
v,1,HASH_JOIN,,92,1.00
v,2,DISTINCT,ea2_part,15,0.90
v,3,HASH_JOIN,ea2_partsupp,74,0.58
v,4,DISTINCT,,50,1.00
v,5,HASH_JOIN,,56,1.00
v,6,HASH_JOIN,ea2_nation:ea2_supplier,69,0.92
v,7,SAMPLER,,36,1.00
v,8,ORDER_BY,,9,1.00
e,0,1
e,1,4
...
e,5,6
#t,115,24
v,0,MULTI_QUERY:COMBINER,ea4_customer,92,0.88
v,1,HASH_JOIN,ea4_orders,38,0.84
...
e,4,5
#t,117,24
v,0,HASH_JOIN,ea2_lineitem,50,0.49
#t,118,24
...
e,6,7
#t,135,24
v,0,GROUP_BY:COMBINER,ea2_lineitem,52,0.83
v,1,SAMPLER,,96,1.00
...
e,3,4
#t,145,24
v,0,HASH_JOIN,ea2_region:ea2_nation,19,0.92
v,1,HASH_JOIN,ea2_supplier,10,0.66
v,2,HASH_JOIN,ea2_partsupp,33,0.81
v,3,HASH_JOIN,ea2_part,27,0.98
...
e,6,7
#t,147,24
v,0,HASH_JOIN,ea0_nation:ea0_region,80,0.76
v,1,HASH_JOIN,ea0_supplier,66,0.34
v,2,HASH_JOIN,ea0_lineitem,33,0.52
v,3,HASH_JOIN,ea0_orders,81,0.56
v,4,HASH_JOIN,ea0_customer,61,0.77
...
e,6,7
#t,148,24
v,0,HASH_JOIN,ea4_orders:ea4_lineitem,20,0.46
...
e,7,8
#t,155,24
v,0,GROUP_BY:COMBINER,ea2_lineitem,84,0.49
v,1,SAMPLER,,84,1.00
...
e,3,4
#t,161,24
v,0,MULTI_QUERY:COMBINER,ea5_customer,61,0.83
v,1,HASH_JOIN,ea5_orders,91,0.31
...
e,3,4
#t,173,24
v,0,HASH_JOIN,ea4_nation:ea4_region,26,0.58
v,1,HASH_JOIN,ea4_supplier,48,0.55
v,2,HASH_JOIN,ea4_lineitem,54,0.43
v,3,HASH_JOIN,ea4_orders,85,0.49
v,4,HASH_JOIN,ea4_customer,91,0.92
...
e,3,4
#t,189,24
v,0,HASH_JOIN,ea2_nation:ea2_region,47,0.40
v,1,HASH_JOIN,ea2_supplier,30,0.68
v,2,HASH_JOIN,ea2_lineitem,43,0.79
v,3,HASH_JOIN,ea2_orders,88,0.98
v,4,HASH_JOIN,ea2_customer,13,0.94
...
e,3,4
#t,193,24
v,0,GROUP_BY:COMBINER,ea1_lineitem,94,0.51
v,1,SAMPLER,,67,1.00
...
e,3,4
#t,199,24
v,0,GROUP_BY:COMBINER,ea0_lineitem,81,0.44
v,1,HASH_JOIN,,87,1.00
v,2,DISTINCT,ea0_part,82,0.65
v,3,HASH_JOIN,ea0_partsupp,84,0.40
v,4,DISTINCT,,12,1.00
v,5,HASH_JOIN,,25,1.00
v,6,HASH_JOIN,ea0_nation:ea0_supplier,50,0.61
v,7,SAMPLER,,20,1.00
